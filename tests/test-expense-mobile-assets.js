...
if (!/General Expense parser v3\.4 not loaded/.test(html)) throw new Error('Missing explicit General Expense parser check');
...
if (!/version:'v3\.4'/.test(html)) throw new Error('Expense page version was not updated');

console.log(JSON.stringify({ localAssets: requiredAssets.length, xlsxVersion: XLSX.version, pageVersion: 'v3.4' }));
